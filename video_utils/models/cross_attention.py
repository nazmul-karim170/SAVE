...
from .save import SVDLinear, SVDGroupNorm, SVDLayerNorm
...
class CrossAttention(nn.Module):
    ...
    def __init__(
        ...
        if self.added_kv_proj_dim is not None:
            ...
            self.add_v_proj = SVDLinear(added_kv_proj_dim, cross_attention_dim)

        self.to_out = nn.ModuleList([])
        self.to_out.append(SVDLinear(inner_dim, query_dim))
